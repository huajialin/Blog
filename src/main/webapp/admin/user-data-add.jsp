...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <form action="${pageContext.request.contextPath}/user.do?action=addUser" method="post">
                <div class="form-group">
                    <label for="name">用户名</label>
                    <input type="text" id="name" name="username" value="" class="form-control" placeholder="输入用户名" required autocomplete="off">
