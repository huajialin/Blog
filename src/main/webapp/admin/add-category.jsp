...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            var url="${pageContext.request.contextPath}/admin/type.do?action=gettype";
            $.post(url,function (data) {
                ...
                for (var i = 0; i < jsonObj.length; i++) {
                    ...
                    html+="<td>"+jsonObj[i].id+"</td>" +
                        ...
                        "<td><a href='type.do?action=getType&id="+jsonObj[i].id+"'>修改</a> <a href='type.do?action=deleteType&id="+jsonObj[i].id+"'>删除</a></td>";
                    html+="</tr>";
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <form action="type.do?action=addtype" method="post" autocomplete="off">
