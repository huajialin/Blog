            ...
            if (name.attr("name") === "see") {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('.see-comment-id').jsp(data.id);
                        $('.see-comment-page').jsp(data.page);
                        $('.see-comment-content').jsp(data.content);
                        $('.see-comment-ip').jsp(data.ip);
                        $('.see-comment-address').jsp(data.address);
                        $('.see-comment-system').jsp(data.system);
                        $('.see-comment-browser').jsp(data.browser);
