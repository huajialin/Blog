...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            var url="${pageContext.request.contextPath}/user.do?action=getAllUser";
            $.post(url,function (data) {
                ...
                for (var i = 0; i < jsonObj.length; i++) {
                    ...
                    html+="<td>"+jsonObj[i].id+"</td>" +
                        ...
                        "<td><a href='${pageContext.request.contextPath}/user.do?action=updateUser&id="+jsonObj[i].id+"'>修改</a> <a href='${pageContext.request.contextPath}/user.do?action=delete&id="+jsonObj[i].id+"'>删除</a> </td>";
                    html+="</tr>";
...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <ol class="breadcrumb">
                <li><a href="user-data-add.jsp">添加用户</a></li>
            </ol>
