...
<head>
    ...
    <!-- 获取转发过来的文章信息-->
    <%
        Object userObj = request.getAttribute("userDTO");
...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <form action="${pageContext.request.contextPath}/user.do?action=newUpdateUser" method="post">
                <div class="form-group">
                    <label for="name">用户名</label>
                    <input type="hidden" name="id" value="<%=userDTO.getId()%>">
                    <input type="text" readonly="readonly" id="name" name="username" value="<%=userDTO.getUsername()%>" class="form-control" required autocomplete="off">
                    <label for="password">密码</label>
                    <input type="password" id="password" name="password" value="" class="form-control" placeholder="输入密码" required autocomplete="off">
                </div>
