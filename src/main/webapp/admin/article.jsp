        ...
        $(function () {
            ...
            $.post(url,function (data) {
                ...
                for (var i = 0; i < jsonObj.length; i++) {
                    html+="<tr>";
                    html+="<td><input type=\"checkbox\" class=\"input-control\" name=\"checkbox[]\" value=\"\" /></td>" +
                        "<td class=\"article-title\">"+jsonObj[i].title+"</td>" +
                        "<td>"+jsonObj[i].typename+"</td>" +
                        "<td>"+jsonObj[i].username+"</td>" +
                        "<td>"+jsonObj[i].time+"</td>" +
                        "<td>" +
                        "<a href='${pageContext.request.contextPath}/articleAll.do?action=update-admin&id="+jsonObj[i].id+"'>修改</a> " +
                        "<a href='${pageContext.request.contextPath}/article.do?action=delete-admin&id="+jsonObj[i].id+"'>删除</a>" +
                        "</td>";
                    html+="</tr>";
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th><span class="glyphicon glyphicon-user"></span> <span class="visible-lg">作者</span></th>
